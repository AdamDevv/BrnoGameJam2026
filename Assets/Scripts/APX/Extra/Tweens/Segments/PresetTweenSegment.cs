    ...
    public class PresetTweenSegment : ABaseTweenSegment, IDirectTweenSegment, IPresetTweenSegment, IParentTweenSegment
    {
        ...
        public void ExtractPreset(InspectorProperty property, bool asSequence)
        {
            ...
            if (property.HasParentObject<ITweenPreset>())
            {
                ...
                if (asSequence)
                {
                    parentList.Insert(index, new SequenceTweenSegment(segmentsCopy.ToList(), _Operation, _InsertionPosition));
                }
                else
                {
            ...
            else
            {
                ...
                if (asSequence)
                {
                    parentList.Insert(index, new SequenceTweenSegment(convertedSegments.ToList(), _Operation, _InsertionPosition));
                }
                else
                {
