...
namespace APX.Extra.Tweens.Segments
{
    ...
    public class ObjectTweenSegment : AObjectTweenSegment, IDirectTweenSegment
    {
        ...
        [UsedImplicitly]
        private bool IsValidTarget(Object target) => ReflectionHelper.GetTypeCacheDerivedClassesOfType<ATweenObjectAction>().Any(tweenAction => tweenAction.IsValidFor(target));
#endif
    }
}
