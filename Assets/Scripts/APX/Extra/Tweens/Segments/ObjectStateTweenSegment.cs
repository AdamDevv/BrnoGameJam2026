...
namespace APX.Extra.Tweens.Segments
{
    ...
    public class ObjectStateTweenSegment : ACallbackTweenSegment, IDirectTweenSegment
    {
        ...
        [InlineProperty]
        [HideLabel]
        private StatePresetField _StatePreset;
        ...
        public ObjectStateTweenSegment(List<ObjectStatePreset> statePresets)
        {
            _StatePreset = new StatePresetField(statePresets);
        }
        ...
        public bool TryConvertToPresetSegment(out IPresetTweenSegment result, IDictionary<Object, TweenObjectReference> references)
        {
            var presets = _StatePreset.ObjectPresets
                .Select(o => new ObjectReferenceStatePreset(
        ...
        public override void PopulateTargets(TweenTargetCollection targets)
        {
            ...
            foreach (var preset in _StatePreset.ObjectPresets) targets.Add(preset.Target, preset.ValuePresets.Select(p => p.TargetType).GetMostSpecificType());
        }
