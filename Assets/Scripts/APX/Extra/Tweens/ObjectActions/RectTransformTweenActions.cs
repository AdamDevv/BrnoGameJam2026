...
namespace APX.Extra.Tweens.ObjectActions
{
    ...
    [Serializable]
    public class RectTransformSizeDeltaWidthTweenAction : ATweenObjectAction<RectTransform>
    {
        [SerializeField]
        private float _EndValue;
        ...
        protected override Tween GetTween(RectTransform target) => target.DOSizeDeltaX(_EndValue, _Duration, _Snapping);
    }

    [Serializable]
    public class RectTransformSizeDeltaHeightTweenAction : ATweenObjectAction<RectTransform>
    {
        [SerializeField]
        private float _EndValue;
        ...
        protected override Tween GetTween(RectTransform target) => target.DOSizeDeltaY(_EndValue, _Duration, _Snapping);
    }
