...
namespace APX.Extra.OdinExtensions.Editor
{
    ...
    {
        private static readonly CustomEditorIconsOverview ICONS_OVERVIEW = new CustomEditorIconsOverview();
        private static readonly ConvertPngToBase64 PNG_TO_BASE64 = new ConvertPngToBase64();

        [MenuItem("APX/Editor Icons")]
        ...
        protected override OdinMenuTree BuildMenuTree()
        {
            ...
            {
                {"Icons Overview", ICONS_OVERVIEW, CustomEditorIcons.Eye},
    ...
    public class ConvertPngToBase64
    {
        ...
        public void OpenFile()
        {
            ...
            PropertyName = Path.GetFileNameWithoutExtension(filePath).Replace("-", " ").Nicify().Replace(" ", "");
        }
