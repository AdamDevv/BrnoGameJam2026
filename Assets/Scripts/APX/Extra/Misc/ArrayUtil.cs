...
namespace APX.Extra.Misc
{
    ...
    #region General Methods
        ...
        public static T FirstOrDefaultValue<T>(this IEnumerable<T> e, T defaultvalue)
        {
            var lst = e as IList<T>;
            if (lst != null)
            {
        ...
        /// <returns></returns>
        public static bool SimilarTo<T>(this IEnumerable<T> first, IEnumerable<T> second) { return first.Except(second).Count() + second.Except(first).Count() == 0; }
        ...
        public static bool ContainsAny<T>(this IEnumerable<T> lst, IEnumerable<T> objs) { return lst.Intersect(objs).Count() > 0; }
        ...
        public static bool Contains(this IEnumerable lst, object obj)
        {
            ...
            while (e.MoveNext())
            {
                if (Equals(e.Current, obj)) return true;
            }
    ...
    #region Array Methods
        ...
        public static int IndexOf(this System.Array lst, object obj) { return System.Array.IndexOf(lst, obj); }
        ...
        public static void Copy<T>(IEnumerable<T> source, System.Array destination, int index)
        {
            if (source is ICollection)
                (source as ICollection).CopyTo(destination, index);
            else
            {
                int i = 0;
