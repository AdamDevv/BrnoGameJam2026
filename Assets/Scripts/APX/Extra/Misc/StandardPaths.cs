...
namespace APX.Extra.Misc
{
    public static class StandardPaths
    {
        ...
        static StandardPaths() { IncludeCompanyName = false; }
        ...
        private static class Linux
        {
            ...
            {
                var result = Environment.GetEnvironmentVariable("XDG_CONFIG_HOME");
                if (string.IsNullOrEmpty(result))
                {
                    var home = Environment.GetEnvironmentVariable("HOME");
            ...
            public static string GetLogDirectory() { return AppendProductPath("/var/log"); }
        }
    }
}
