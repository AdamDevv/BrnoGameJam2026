...
namespace VInspector
{
    ...
    {
        public static bool navigationBarEnabled { get => EditorPrefsCached.GetBool("vInspector-navigationBarEnabled", true); set => EditorPrefsCached.SetBool("vInspector-navigationBarEnabled", value); }
        public static bool copyPasteButtonsEnabled { get => EditorPrefsCached.GetBool("vInspector-copyPasteButtonsEnabled", true); set => EditorPrefsCached.SetBool("vInspector-copyPasteButtonsEnabled", value); }
        public static bool playmodeSaveButtonEnabled { get => EditorPrefsCached.GetBool("vInspector-saveInPlaymodeButtonEnabled", true); set => EditorPrefsCached.SetBool("vInspector-saveInPlaymodeButtonEnabled", value); }
        public static bool componentWindowsEnabled { get => EditorPrefsCached.GetBool("vInspector-componentWindowsEnabled", true); set => EditorPrefsCached.SetBool("vInspector-componentWindowsEnabled", value); }
        public static bool componentAnimationsEnabled { get => EditorPrefsCached.GetBool("vInspector-componentAnimationsEnabled", true); set => EditorPrefsCached.SetBool("vInspector-componentAnimationsEnabled", value); }
